...
Fork the following repo `https://github.com/davgordo-open-idp/backstage-demo` to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/davgordo-open-idp/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/davgordo-open-idp/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/cluster-zhg2f.zhg2f.sandbox628.opentlc.com/${base_domain}/g" {} +
git add -A
...
Fork the following repo `https://github.com/davgordo-open-idp/shared-workflows` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/davgordo-open-idp/software-templates` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/davgordo-open-idp/backstage-app-demo` to your organization.
